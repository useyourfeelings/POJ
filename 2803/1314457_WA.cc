...
int main()
{
    ...
    for(i = 0; i < n; ++ i)
    {
        ...
        if(len >= 2 && t[len - 1] == 'r' && t[len - 2] == 'e')
        {
            printf("one who ");
            len -= 2;
            s = 1;
        }
        else if(len >= 3 && t[len - 1] == 'g' && t[len - 2] == 'n' &&
                            t[len - 3] == 'i')
        {
            printf("to actively ");
            len -= 3;
        }
        else if(len >= 3 && t[len - 1] == 'e' && t[len - 2] == 'z' &&
                            t[len - 3] == 'i')
        {
            printf("change into ");
            len -= 3;
        }
        else if(len >= 4 && t[len - 1] == 'n' && t[len - 2] == 'o' &&
                            t[len - 3] == 'i' && t[len - 4] == 't')
        {
